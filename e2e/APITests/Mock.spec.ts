...
test.skip("Hace un mock de un valor que no viene de la API real ", async ({
  page,
  context,
}) => {
    ...
    const json = [
      {
        ...
        imageUrl:
          "https://uploads.exoticca.com/home-suggested-destinations/country/1.png",
      },
    ];
...
test("Obtengo la respuesta real y le agrego algo no tan real", async ({
  page,
  context,
}) => {
